Sub csv_main()
    ...
    'アクティブ
    Workbooks("原料預け戻し.xlsm").Activate
...
Sub one_search()
    ...
    For i = 1 To UBound(aduke_data)
        If i = 1 Then
            ...
            Next c
            r = r + 1
        ElseIf aduke_data(i, 10) = "預け" And aduke_data(i, 12) = date_G2 Then
            For c = 1 To UBound(aduke_data, 2)
    ...
    'クリアして貼り付け
    Worksheets("預け形成").Activate
    Worksheets("預け形成").Cells.ClearContents
    ...
    For i = 1 To UBound(aduke_data)
        If i = 1 Then
            ...
            Next c
            r = r + 1
        ElseIf aduke_data(i, 10) = "戻し" And aduke_data(i, 12) = date_G2 Then
            For c = 1 To UBound(aduke_data, 2)
